...
E_RAW = [
    ...
    ("Alfa Engenharia","Legacy Residence",
     ...
     "N/A","N/A","imprensa",
     "https://www.alfaengenharia.com.br","14/04/2026",
     "Tipologia detalhada: 4 suítes. 13 opções de lazer, elevador privativo. Book local (375MB) + site oficial. Sem ticket público."),
    ...
    ("Alfa Engenharia","LIV Residence",
     ...
     "N/A","N/A","site_oficial",
     "https://www.alfaengenharia.com.br","14/04/2026",
     "Tipologia detalhada: 3 suítes. 1º Housi do MA. Book local + site Alfa. Sem tabela comercial."),
    ...
    ("Delman","Azimuth",
     ...
     "Tipologia detalhada: 3 suítes. Tabela 04/2026: 1 apto (901) de 30. ≈97% vendido. Lançamento confirmado 2023 pela imprensa."),
    ...
    ("Delman","Landscape",
     ...
     "tabela_local","tabela_local","imprensa",
     "https://www.delman.com.br","14/04/2026",
     "Tipologia detalhada: 3 suítes. Tabela 04/2026 marcada 'pré-lançamento'. Fonte web confirma lançamento 2026. Duplex cobertura 123-143m²."),
    ...
    ("Delman","Quartier 22",
     ...
     "https://www.delman.com.br","14/04/2026",
     "Tipologia detalhada: 3 suítes. Entrega iminente. 1 apto (601) de 30 à venda. ≈97% vendido."),
    ...
    ("Delman","Sky Residence",
     ...
     "tabela_local","tabela_local","estimativa_T-36",
     "https://www.delman.com.br","14/04/2026",
     "Tipologia detalhada: 4 suítes. Prédio pequeno (12 aptos). 1 à venda. ≈92% vendido."),
    ...
    ("Delman","Studio Design 7 Península",
     ...
     "tabela_local","tabela_local","estimativa_T-36",
     "https://www.delman.com.br","14/04/2026",
     "Tipologia detalhada: Studio / 1Q. 33 de 125 aptos à venda. ≈74% vendido em ~18 meses. Forte velocidade em compactos."),
    ...
    ("Delman","Wave Residence",
     ...
     "tabela_local","tabela_local","imprensa",
     "https://www.delman.com.br","14/04/2026",
     "Tipologia detalhada: 4 suítes. Evento de apresentação oficial 2024. 5 de 30 à venda. ≈83% vendido. Piscina privativa na varanda."),
    ...
    ("Ergus","Nexus Renascença",
     ...
     "Tipologia detalhada: Studio a 2Q. Complexo 10mil m² multi-produto (residencial + comercial + Open Mall). Book local + site oficial."),
    ...
    ("Treviso","Vernazza Torre Sul",
     ...
     "—","23/04/2026",
     "Tipologia detalhada: 87,98 e 90,10 m² (Norte/Sul). Lançamento 02/2025 informado pelo Rafael. 26 unid listadas, área 87,98/90,10 m². Ticket R$ 1,28-1,59M (méd R$ 1,40M). R$/m² pond R$ 15.600 (faixa R$ 14,2-17,6k). VGV listado R$ 36,3M. Entrega 12/2029. [reconstituído da v4.16 em 25/04/2026]"),
    ...
    ("Treviso","Altos do São Francisco",
     ...
     "Tipologia detalhada: 2-3Q (1 ou 2 vagas). IMÓVEL PRONTO. 26+ unid na tab ABR/26 (VGV R$ 15,8M). Tipos: 57,93 m² (1 vaga) e 67,15 m² (2 vagas). Ticket R$ 495k–762k (méd R$ 607k). R$/m² pond R$ 10.042. Estoque amplo. [reconstituído da v4.16 em 25/04/2026]"),
    ...
    ("Niágara","ORO Ponta d'Areia",
     ...
     "Tipologia detalhada: 2-4 suítes. Tabela JAN/26 é matriz por posição (não espelha estoque). Duplex cobertura 160m². Parcelamento 48m pós-assinatura."),
    ...
    ("Mota Machado","Entre Rios",
     ...
     "Tipologia detalhada: 3 suítes (1 master). 3 tipologias (125 / 146,82 / 156,94 m²). 2 torres x 15 pav. Tab ABR/26: 15 unid, VGV R$ 32,3M. Ticket R$ 1,73–2,72M (méd R$ 2,15M). R$/m² pond R$ 15.162 (faixa R$ 13,9k–17,3k). Rua dos Bicudos, Renascença. [reconstituído da v4.16 em 25/04/2026]"),
    ...
    ("Mota Machado","Al Mare Tirreno",
     ...
     "tabela","tabela","book",
     "https://motamachado.com.br","23/04/2026",
     "Tipologia detalhada: 4 suítes, 3 vagas. Torre A 'Tirreno' da Mota Machado Collection. Imóvel PRONTO. 215 m², 4 suítes, 3 vagas. Apts 102, 201, 202 listados. Ticket R$ 3,02-3,12M. R$/m² méd R$ 14.293. Av. dos Holandeses / São Marcos. [reconstituído da v4.16 em 25/04/2026]"),
    ...
    ("Sá Cavalcante","Ilha Parque Residence",
     ...
     "Tipologia detalhada: 2-3 quartos. 120 aptos (60 2Q + 60 3Q), 12/andar, 15 pavs. Pronto p/ morar. Ao lado do Shopping da Ilha."),
    ...
    ("Alfa Engenharia","Giardino Residenza Torre Fiore",
     ...
     "Tipologia detalhada: 2 suítes + 2 semi-suítes OU 3 suítes, varanda, lavabo, 3 vagas, depósito. Torre NORTE do Giardino. 15 pav × 3 un = 45 unidades. 3 tipologias: 127,30 / 128,37 / 110,77 m². Tabela MAR/2026: 6 unidades disponíveis (1001/701/201/101 da coluna 127m², 102 da coluna 128m², 1403 da coluna 110m²) = ~13% estoque, 87% VENDIDO → Últimas unidades. Entrega DEZ/29. Memorial R.06/56.931 - 1º RI SL. Endereço Alfa: Rua Peixe Pedra, Qd 12 lote 04, Calhau."),
    ...
    ("Treviso","Villagio Treviso",
     ...
     "Tipologia detalhada: Terrenos em condomínio. Condomínio de terrenos (loteamento fechado). Divulgação ativa abr/2026. Sem tabela pública mapeada."),
    ...
    ("Castelucci","Villa di Carpi",
     ...
     "Tipologia detalhada: 2Q. Compactos 49-52m², 2Q. Público Cohatrac/médio. Instagram @construtoracastelucci anunciou como lançamento; preço não divulgado."),
    ...
    ("Castelucci","Residencial Ana Vitória",
     ...
     "https://construtoracastelucci.com.br","14/04/2026",
     "Tipologia detalhada: 2-3Q. Apartamentos 2-3Q Araçagy. Site oficial Castelucci."),
    ...
    ("DOM Incorporação","Edifício Dom Ricardo",
     ...
     "Tipologia detalhada: 2-3Q. DOM Incorporação com MB Engenharia como sócia (empreendimento conjunto). Lançamento 12/2023 confirmado internamente. Próximo à Praça da Lagoa (Foguete). 'Sucesso de vendas, 6 unidades disponíveis' (IG jan/2025). Estoque estimado ≤6%. [reconstituído da v4.16 em 25/04/2026]"),
    ...
    ("MB Engenharia","Condomínio Prime Cohama",
     ...
     "Tipologia detalhada: Casas duplex. 22 casas duplex 140m² — produto horizontal diferenciado. Pré-lançamento anunciado 2023, hoje em comercialização."),
    ...
    ("DOM Incorporação","Dom Antônio",
     ...
     "Tipologia detalhada: 3Q casas duplex. DOM Incorporação com MB Engenharia como sócia (empreendimento conjunto). Lançamento 06/2023 confirmado internamente. Casa duplex 3Q, 136m², R$906.870. Produto horizontal Eldorado/Turú. [reconstituído da v4.16 em 25/04/2026]"),
